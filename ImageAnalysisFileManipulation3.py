...
for subdir in os.listdir(directory):
        ...
        for file in os.listdir(directory + subdir + "\\Analysis"):
            ...
            Add the data from branchSummary
            ...
            summarySeries = summarySeries.append(averages[1:9])
            summarySeries = summarySeries.append(TMRE_MTGRatio)
            summarySeries = summarySeries.append(FFSeries)
            summarySeries = summarySeries.append(sumSeries[1:2])
            ...
            with open(directory + subdir + "\\Summary\\" + subdir + " Master Summary " + name + ".csv", 'a') as f:
                summaryDataTransposed.to_csv(f, header=False)
                f.close()
