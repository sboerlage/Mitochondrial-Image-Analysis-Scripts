...
for subdir in os.listdir(directory):
        ...
        header = pd.DataFrame(['0','Index','Count','Area','Perim.','Circ.','AR','Round','Solidity','MTG','TMRE','Ratio','FormFactor','TotalArea','Branches','Branch Length','Branch Points','Branches per Mito','Branch Length per Mito','Branch Points per Mito'])
